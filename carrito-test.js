// Versión modificada de carrito.js para testing
...
function actualizarResumen() {
  if (!subtotalElem || !costoEnvioElem || !descuentoElem || !totalPagarElem) return;
...
// Solo ejecutar si estamos en el navegador (no en testing)
