...
// Se importan las regiones y comunas de Chile
import { regions, comunas } from '../../utils/chileRegions'; 
...
const RegisterPage = () => {
  ...
  const handleChange = (e) => {
    ...
    // Si se cambia la región, limpiar la comuna seleccionada
    if (id === 'region') {
      setFormData(prev => ({ ...prev, [id]: value, comuna: '' }));
    } else {
  ...
  // Filtrar comunas basándonos en la región seleccionada (para mejor UX)
